	...
	public void addEinnahme(View view) {
		...
		try {
			...
			BudgetLoader.addEinmaligeTransaktion(getApplicationContext(), id,
					anmerkungFeld.getText().toString(), datumFeld.getText()
							.toString(), zeitFeld.getText().toString(),
					kategorieSpin.getSelectedItem().toString(), betragFeld
							.getText().toString());
			...
			if (kategorieSpin.getSelectedItem().toString() != "ohne Kategorie") {
				...
				BudgetLoader.addEinmaligeTransaktionToKategorie(
						getApplicationContext(),
						datumFeld.getText().toString(), kategorieSpin
								.getSelectedItem().toString(), betragFeld
								.getText().toString());
