...
public class MonatlichesActivity extends BaseActivity {
	...
	private void deleteListItem(String name) {
		...
		try {
			db.delete(transEntry.TABLE_NAME_AUTOMATIC,
					transEntry.M_COLUMN_NAME_BEZEICHNER + "= '" + name + "'",
					null);
		} catch (Exception e) {
			AlertDialog.Builder alert = new AlertDialog.Builder(this);
	...
	public List<itemListData> getDataForListiew() {
		...
		String[] projection = { transEntry.M_COLUMN_NAME_BEZEICHNER,
				...
				transEntry.M_COLUMN_NAME_DATUM, transEntry.M_COLUMN_NAME_TAG };
	...
	public class itemListAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				LayoutInflater inflater = (LayoutInflater) MonatlichesActivity.this
						.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
				arg1 = inflater
						.inflate(R.layout.listitemmonatlich, arg2, false);
			}
			...
			if (Integer.parseInt(data.betrag) >= 0) {
				...
				datum.setText("Zubuchen von " + data.betrag + "€ zum: "
						+ data.zumTag + ". des Monats");
			} else {
				img.setImageResource(R.drawable.ic_action_not_important);
				datum.setText("Abbuchen von " + data.betrag + "€ zum: "
						+ data.zumTag + ". des Monats");
			}
