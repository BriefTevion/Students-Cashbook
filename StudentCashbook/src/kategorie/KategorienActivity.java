...
public class KategorienActivity extends BaseActivity {
	...
	private void deleteListItem(String name) {
		...
		try {
			db.delete(transEntry.TABLE_NAME_Kategorie,
					transEntry.K_COLUMN_NAME_BEZEICHNER + "= '" + name + "'",
					null);
	...
	public class itemListAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if (arg1 == null) {
				LayoutInflater inflater = (LayoutInflater) KategorienActivity.this
